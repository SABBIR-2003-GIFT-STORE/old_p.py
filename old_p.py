...
def ua():
    ...
    return xx
#----------------------------[LOGO]-----------------------------------#
logo = (f"""         .dP"Y8    db    88""Yb 88""Yb 88 88""Yb 
`Ybo."   dPYb   88__dP 88__dP 88 88__dP 
o.`Y8b  dP__Yb  88""Yb 88""Yb 88 88"Yb  
8bodP' dP""""Yb 88oodP 88oodP 88 88  Yb
\x1b[1;97m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
\x1b[38;5;8m(\x1b[1;97m~\x1b[38;5;8m) \x1b[38;5;47mDEVELOPER \x1b[1;97m: SABBIR KHAN
\x1b[38;5;8m(\x1b[1;97m~\x1b[38;5;8m) \x1b[38;5;47mFACEBOOK  \x1b[1;97m: SABIR KHAN
\x1b[38;5;8m(\x1b[1;97m~\x1b[38;5;8m) \x1b[38;5;47mGITHUB    \x1b[1;97m: Sabbir2245
━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━""")
#----------------------------[MAIN/DEF]-----------------------------------#
def main():
    user=[]
    ...
    if ask in["1"]:
        ...
        for i in range(int(limit)):
            data=str(random.choice(range(1000000000,1999999999)))
            user.append(data)    
    with ThreadPool(max_workers=40) as sabbir:
        os.system('clear')
        print(logo)
...
def login(uid):
    ...
    try:
        sys.stdout.write(f"\r\x1b[38;5;8m(\x1b[1;97m{date}\x1b[38;5;8m) \x1b[38;5;8m(\x1b[1;97m{loop}\x1b[38;5;8m) \x1b[38;5;8m(\x1b[1;97m{len(oks)}
